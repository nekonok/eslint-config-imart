  ...
  parsers: [
    {
      parse: result => {
        ...
        $(".icon-jsdoc-namespace").closest("li").each(function() {
          if (!$(this).text().match(/_global_/)) {
            return true;
          }

          $(this).find("span.jsdoc-class-index").each(function() {
            if ($(this).text().match(/_global_/)) {
              return true;
            }
        ...
        $("span.jsdoc-class-index").each(function() {
          if (!$(this).text().match(/im.*Message/)) {
            return true;
          }
          apiList.push($(this).text());
          return true;
...

    {
      ...
      targets: [
        ...
        },
        {
          ...
          url:
            "http://www.intra-mart.jp/apidoc/pdfd/functioncontainer/allclasses-frame.html"
        },
        {
