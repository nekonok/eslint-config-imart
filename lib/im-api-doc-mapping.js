...
module.exports = {
  parsers: [
...

    {
      ...
      targets: [
        {
          display: "intra-mart Accel Kaiden!",
          file: "iap-client-kaiden",
          url: "http://www.intra-mart.jp/apidoc/iak/JsDoc/symbols/KAIDEN.html"
        }
      ]
    },
...

    {
      ...
      targets: [
        ...
        },
        {
          ...
          file: "iap-server-bpm",
          url:
            "http://www.intra-mart.jp/apidoc/bpm/apilist-bpm-ssjs/doc/bpm/index.html"
        },
        {
          display: "IM-Mail",
          file: "iap-server-mail",
          url:
            "http://www.intra-mart.jp/apidoc/immail/apilist-im_mail-ssjs/doc/im_mail/index.html"
        }
      ]
    },
    {
      parse: result => {
        const apilist = parseIAP(result);
        apilist.push("FRApplicationDataManager");
        return apilist;
      },
      targets: [
        {
